...
public class client {
    private  static  final  String BASE_URL="http://192.168.43.2/rental-api/";
    private  static  final  String BASE_URL_IMAGE="http://172.20.10.7/rental-api/upload/avatars/";
    private  static  final  String BASE_URL_IMG="http://172.20.10.7/rental-api/upload/";
